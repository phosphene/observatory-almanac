---
title: "Guitar & Ukulele Reference Guide"
area: arts-recreation
type: almanac
source: Observatory Almanac
source_path: docs/21-music-performance/guitar-ukulele.md
license: MIT
updated: 2026-04-28
summary: >
...
<div id="metronome-tool" class="wm-tool">
<h3>Practice Metronome</h3>
<div style="display:flex; align-items:center; gap:12px;">
<input class="metro-bpm" type="number" value="120" min="40" max="240" style="width:80px; padding:8px; font-size:16px; text-align:center; border:1px solid #ccc; border-radius:4px;">
<span>BPM</span>
<button class="wm-btn wm-btn-primary metro-start">▶️ Start</button>
<button class="wm-btn metro-stop">⏹️ Stop</button>
<div class="metro-beat" style="width:30px; height:30px; border-radius:50%; background:#B8960C; transition:transform 0.1s;"></div>
</div>
</div>

<button class="wm-btn metro-tap" style="margin-top:8px;">👆 Tap Tempo</button>
<span class="metro-bpm-display" style="margin-left:12px; font-family:monospace; font-size:18px;"></span>
