---
title: "Music Theory: The Grammar of Sound"
area: arts-recreation
type: almanac
source: Observatory Almanac
source_path: docs/21-music-performance/music-theory.md
license: MIT
updated: 2026-04-28
summary: >
...
**Consonant intervals** (stable, pleasant): Unison, octave, perfect 5th, major/minor 3rd, major/minor 6th
**Dissonant intervals** (tense, want resolution): 2nds, 7ths, tritone
...
A chord can be played with any note on the bottom (bass):
- **Root position:** C-E-G (C on bottom)
- **First inversion:** E-G-C (E on bottom)
...
A time signature like **4/4** means:
- Top number: 4 beats per measure
- Bottom number: the quarter note (4) gets one beat
