---
title: 'Agrivoltaics: The Farm-to-Solar Trend That Can Help Accelerate the Renewable Energy Transition'
area: environment
type: article
author: Tina Casey
author_slug: tina-casey
source: Earth Food Life Project
source_url: https://observatory.wiki/Agrivoltaics:_The_Farm-to-Solar_Trend_That_Can_Help_Accelerate_the_Renewable_Energy_Transition
license: CC BY-NC-SA 4.0
published: '2024-11-12'
updated: '2024-11-12'
summary: Using the same land for the production of both agriculture and solar energy is a win-win for the climate and farmers. Access to solar power is increasing in rural parts of the U.S., partly with the support of farmers who lease out their land for utility-scale solar arrays.
tags:
- environment
- climate-change
- genetics
...
However, in the absence of any significant environmental impacts, solar projects can still face opposition based on disinformation about climate change. In April 2022, Reuters drew attention to a relatively recent sharp increase in the number of Facebook groups dedicated to blocking rural solar.
