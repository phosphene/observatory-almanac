---
title: "Weather & Climatology: Understanding the Atmosphere"
area: environment
type: almanac
source: Observatory Almanac
source_path: docs/03-living-environment/weather-climatology.md
license: MIT
updated: 2026-04-28
summary: >
...
## PART ONE: BAROMETRIC PRESSURE

### What Is Atmospheric Pressure?

Atmospheric pressure is the weight of the air column above you pressing down. At sea level, standard pressure is **1013.25 hPa** (hectopascals), equivalent to **29.92 inches of mercury (inHg)** or **760 mmHg**. This number represents the total mass of the atmosphere above a square meter of Earth's surface: approximately 10,330 kilograms.

Pressure varies with altitude (it drops roughly 1 hPa for every 8 meters of climb at sea level) and with weather systems. This variation is what makes pressure such a powerful forecasting tool.
...
### Pressure and Weather: The Basic Framework
...
**3-hour tendency rules (the barometer forecaster's shorthand):**
...
- Air descends in the center, diverges at the surface
- In Northern Hemisphere: clockwise rotation
- Brings clear skies (descending air suppresses cloud formation), dry conditions
- Can persist for days to weeks ("blocking highs")
- Extreme high pressure = very stable, possible fog in valleys at night
...
The **tighter the pressure gradient** (isobars spaced closer together on a weather map), the **stronger the wind**. Isobars are lines connecting equal pressure values. Where they're packed close: high winds. Where they're spread apart: calm.

---

## PART TWO: DEW POINT AND HUMAN COMFORT
...
## PART THREE: WIND CHILL AND HEAT INDEX
...
## PART FOUR: READING WEATHER MAPS

### Surface Analysis Maps

A surface analysis map (synoptic chart) shows current or forecast surface conditions:
...
Wind direction and speed on weather maps use "barbs" on a staff:
- Staff points **toward** the direction wind is blowing **from**
- Barbs (short lines): Each full barb = 10 knots; half barb = 5 knots; pennant = 50 knots
- Example: A staff pointing northwest with 2 full barbs = NW wind at 20 knots

### Color-Coded Radar (NEXRAD)
...
**2. Cirrocumulus (Cc)**  
*"Mackerel sky"*  
Small white puffs arranged in rippled rows or a dappled pattern. Much smaller than altocumulus (thumbnail or smaller held at arm's length). Composed of supercooled water droplets. Less common than other high clouds. A mackerel sky in the morning can indicate weather change within 24 hours.
...
**7. Stratus (St)**  
A flat, uniform low gray layer resembling fog that doesn't reach the ground. Produces drizzle rather than rain. Common in coastal areas (particularly California coast) and in stable, moist air masses. Often forms overnight, burns off by mid-morning when present.
...
**10. Cumulonimbus (Cb)**  
The storm cloud. Towers can reach 60,000 feet (18,000 m) into the stratosphere. The anvil-shaped top (cirrus anvil), characteristic of mature thunderstorms, marks where rising air hits the tropopause and spreads outward. Contains: lightning, thunder, violent updrafts/downdrafts, heavy rain, hail, possible tornadoes (supercell variety). The cumulonimbus commands respect. Give it a wide berth if outdoors.

---

## PART SIX: SEVERE WEATHER PREPAREDNESS BY TYPE

### Thunderstorms

**Preparation:**
- 30-30 rule: If thunder follows lightning by 30 seconds or less, seek shelter immediately; wait 30 minutes after last thunder to resume outdoor activity
- Indoors: Avoid windows, plumbing, corded phones, electrical equipment
- Outdoors: Seek low ground; avoid tall isolated trees; crouch low if caught in open; never lie flat
- Vehicle: A hard-top vehicle provides good protection; convertibles/open vehicles do not

**Hail:** Most injuries occur when people are caught outside or near windows. Protect your head; shelter in an interior room.
...
**Two rules:**
1. **Turn Around, Don't Drown**: Six inches of moving water can knock a person down; two feet can float a car
2. **Never drive around barricades on flooded roads**

Flash flood watches vs. warnings mirror thunderstorm protocol. Flash flooding is the #1 weather-related killer in the US.
...
**Ice storms:** More dangerous than snow for infrastructure and falls. A 1/4-inch coating of ice can cause widespread power outages; tree branches and power lines fail.
...
**Evacuation:** When authorities order evacuation, leave. Every storm has exceptions that kill people who stayed to prove it wouldn't be that bad.

### Heat Emergencies

**Heat exhaustion:** Heavy sweating, weakness, cold pale clammy skin, fast/weak pulse, nausea. Move to cool location; sip cool water; cool cloths to skin.

**Heat stroke:** Hot red dry or damp skin, rapid strong pulse, possible confusion. This is a medical emergency. Call 911. Cool the person rapidly by any means available (ice bath, cool water, fanning). Do not give fluids to someone who is unconscious or confused.

---

*Further reading: National Weather Service (weather.gov), The AMS Weather Book (Jack Williams), Storm King (David Brooks), Meteorology Today (Ahrens & Henson).*
