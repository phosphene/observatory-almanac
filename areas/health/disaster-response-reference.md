---
title: "Disaster Response Reference"
area: health
type: reference
source: Observatory Almanac
source_path: docs/14-emergency-response/disaster-response.md
license: MIT
updated: 2026-04-28
summary: >
...
**If in a vehicle:**
- If shelter is reachable quickly, go there.
- If not, drive at right angles to the tornado path.
- If caught: Stay buckled, head below windows, cover head.
...
- Evacuate if in a mobile home, low-lying area, or flood zone.
- Evacuate if you cannot safely shelter in place.
...
**If trapped:**
- Close door. Seal gaps with clothing.
- Signal from window.
...
**For pets:** Food, water, carrier, vaccination records
**For elderly/disabled:** Extra mobility aids, hearing aid batteries, medical supplies
