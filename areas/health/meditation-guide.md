...
source_path: docs/17-body-movement/meditation-guide.md
license: MIT
updated: 2026-04-28
summary: >
  Nine traditions. One practice.
tags:
  - movement
  - yoga
  - health
...
<details class="wm-article-tools"><summary>🛠️ Practice Tools</summary>
<ul>
<li><strong>🧘 Meditation Timer</strong> (below)</li>
<li><a href="../breathing-techniques/#practice-now">🫁 Guided Breathing</a></li>
<li><a href="../yoga-basics/">🧘‍♀️ Yoga Basics</a></li>
<li><a href="../stretching-routines/">💪 Stretching Routines</a></li>
</ul>
</details>

*Nine traditions. One practice. A lifetime of exploration.*

Meditation is not emptying the mind — it is learning to observe the mind. Each tradition below offers a distinct entry point into this observation, drawing from thousands of years of practice across Asia, the Middle East, and indigenous cultures worldwide. Whether you have five minutes or fifty, whether you are drawn to silence or structure, there is a path here for you.

---

## How to Use This Guide

Read through all nine styles before committing to one. Try each for at least a week before evaluating. Most practitioners settle into one primary practice and draw from others as needed. Session length is less important than consistency — ten minutes daily outperforms two hours weekly.
...
- Sit on a chair, cushion, or floor — comfort matters more than form
...
**Tradition/Lineage:** Theravāda Buddhism, originating in Southeast Asia (Myanmar, Thailand, Sri Lanka). Popularized in the West by teachers such as S.N. Goenka, Joseph Goldstein, Sharon Salzberg, and Jack Kornfield. The ten-day Goenka retreat is one of the most widely taught introductory formats.

**Core Principle:** Vipassana means "clear seeing" or "insight." The practice cultivates moment-to-moment awareness of sensations, thoughts, and emotions exactly as they arise — without reacting, clinging, or pushing away. Over time, practitioners observe the three characteristics of existence: impermanence (anicca), unsatisfactoriness (dukkha), and non-self (anatta).
...
5. If the mind wanders to thought, planning, memory, or fantasy — note it neutrally ("thinking") and return to the body scan.
6. Notice that all sensations — even intense pain — arise and pass. Everything is impermanent.
...
| Frustration at mental chatter | The noticing of distraction IS the practice — not a failure |
...
**Tradition/Lineage:** Theravāda Buddhism; one of the four brahmaviharās (divine abodes) alongside compassion (karuṇā), empathetic joy (muditā), and equanimity (upekkhā). Extensively developed in Tibetan Buddhism as tonglen (giving and taking). Western teachers: Sharon Salzberg, Pema Chödrön.

**Core Principle:** Metta means "loving-kindness" or "benevolent goodwill." The practice deliberately cultivates warmth, care, and well-wishing — beginning with oneself and radiating outward to increasingly challenging targets. It directly counters habitual states of judgment, resentment, and self-criticism.
...
3. Repeat each phrase slowly, feeling into its meaning rather than rushing. Allow any warmth to arise naturally — do not force it.
4. After 3–5 minutes, bring to mind a beloved person (a close friend, child, or pet). Direct the same phrases toward them: *May you be happy. May you be healthy...*
5. Expand to a neutral person — someone you neither like nor dislike, perhaps a neighbor or shop clerk.
6. If you are working with interpersonal difficulties, bring to mind a "difficult person." Offer the phrases, even if the warmth is forced or absent.
7. Finally, expand to all beings everywhere: *May all beings be happy. May all beings be safe...*
...
| Self-directed phrases feel hollow or uncomfortable | This is common and meaningful — the self often receives the least compassion |
...
1. Lie down on your back in savasana position — arms slightly away from the body, palms up, legs uncrossed. You may use a blanket.
...
4. On an exhale, release awareness from the left foot and move to the left lower leg — the calf, the shin, the ankle.
...
**Suggested Duration:**
- Beginner: 20–30 minutes (this practice benefits from unhurried pacing)
- Intermediate: 30–45 minutes
...
| Discomfort or pain in a region | Do not skip it — breathe into it; stay curious rather than resistant |

---

## 4. Zazen (Zen Sitting)

**Tradition/Lineage:** Zen Buddhism (Chan in China, Seon in Korea, Thiền in Vietnam). Dōgen Zenji (13th century Japan) formalized zazen in his text *Fukanzazengi*. The practice is central to both Rinzai and Sōtō Zen schools. Contemporary Western Zen teachers include Shunryu Suzuki (*Zen Mind, Beginner's Mind*) and Thich Nhat Hanh.

**Core Principle:** Zazen ("seated Zen") is not a technique for achieving a state — it *is* the state. The practice is often described as "just sitting" (shikantaza). Form, posture, and attitude are as important as mental activity. Dōgen taught: "To study the self is to forget the self."

**Complete Instructions — Counting Breaths (Entry Practice):**
...
**Suggested Duration:**
- Beginner: 15–20 minutes, once or twice daily
...
6. Visualization: Follow any guided imagery offered — a starry sky, a golden sun, a still lake.
...
| Not being able to follow the rotation fast enough | Don't worry — approximate attention is sufficient |
...
**Tradition/Lineage:** Present in Theravāda Buddhism (kinhin in Japanese Zen, used between sitting periods), Tibetan Buddhist traditions, and Thich Nhat Hanh's Plum Village tradition. Also appears in Christian contemplative walking (labyrinth walking) and Sufi traditions.
...
1. Choose a clear path of 10–20 steps (indoors or outdoors). Remove shoes if possible.
...
**Tradition/Lineage:** Vedic tradition dating back thousands of years; central to Hindu devotional practice (japa — repetition of deity names), Transcendental Meditation (TM, founded by Maharishi Mahesh Yogi in the 1950s), and Tibetan Buddhism (mantra recitation, e.g., *Om Mani Padme Hum*). Also found in Christian hesychasm (the "Jesus Prayer") and Sufi dhikr.
...
- *So Hum* ("I am that" — Sanskrit; synchronize "So" with inhale, "Hum" with exhale)
...
2. Introduce the mantra silently: repeat it gently in your mind. Do not force it or mechanically clock it — let it arise naturally.
3. When the mind wanders to thought, return to the mantra. Do not be harsh.
4. Allow the mantra to become quieter and quieter, more like a whisper than a shout. It may become very faint or disappear entirely — this is fine. It will return.
5. After the session, sit quietly for 2–3 minutes before opening your eyes. This transition time is valued in TM as part of the integration process.

**Suggested Duration:**
- Beginner: 10–15 minutes, twice daily (TM recommends this frequency)
- Intermediate: 20 minutes twice daily
- Advanced: 20–30 minutes twice daily
...
| Choosing the "right" mantra | Start with *So Hum* — it is well-tested and widely used |

---

## 8. Mindfulness of Breath (Ānāpānasati)

**Tradition/Lineage:** Explicitly taught by the Buddha in the *Ānāpānasati Sutta* (Discourse on Mindfulness of Breathing), part of the Majjhima Nikāya. Practiced across virtually all Buddhist schools. The most widely taught secular meditation form in clinical settings (MBSR, MBCT). Foundation of most Western mindfulness instruction.

**Core Principle:** The breath is always present, always in the moment, always arising and passing. By anchoring attention to the breath, practitioners train the capacity to observe without grasping. The breath is the meditation object; wandering and returning to it builds attentional stability (samādhi).
...
3. Rest your attention there. You do not need to control the breath — breathe naturally.
4. When the mind wanders (and it will, repeatedly — this is not failure), simply notice that it has wandered and gently return to the breath.
...
7. Over time, the returns become shorter and the breath periods longer — this is concentration developing.
...
**Suggested Duration:**
- Beginner: 5–10 minutes (this is the easiest entry point; short sessions are encouraged)
- Intermediate: 20–30 minutes
- Advanced: 45+ minutes
...
**Core Principle:** Rather than focusing on any particular object (breath, sensations, mantra), the practitioner rests in the open, spacious quality of awareness itself — the medium in which all experiences arise and pass. There is no "doing" in this practice; rather, the habitual search for a meditation object is relaxed, and awareness is recognized as already present.
...
1. Begin with 5–10 minutes of breath awareness to settle the mind.
...
**Suggested Duration:**
- Beginner: 5–10 minutes appended to another practice
- Intermediate: 15–20 minutes as a standalone practice
- Advanced: 30–45 minutes, or as the primary practice for experienced meditators

**Common Obstacles & Solutions:**

| Obstacle | Solution |
|----------|----------|
| "I don't understand what I'm supposed to do" | That confusion IS the practice pointing — there is no doer to do anything |
...
|----------|-------------|-----------|----------|------------|
| Vipassana | Body sensations | Theravāda Buddhism | Insight, habit change | Intermediate |
| Metta | Phrases + visualization | Buddhism | Emotional healing, relationships | Beginner-friendly |
| Body Scan | Body regions | MBSR / Theravāda | Stress, pain, sleep | Beginner |
...
| Breath (Ānāpānasati) | Breath sensations | Buddhism / Secular | Attention training | Beginner |
...
**Week 1–2:** Mindfulness of Breath, 5–10 minutes daily
**Week 3–4:** Extend to 15–20 minutes; experiment with Body Scan before sleep
**Month 2:** Add Metta 2–3 times per week; try Walking Meditation on weekends
...
<div id="meditation-tool" class="wm-tool" style="text-align:center;">
<h3>Sit. Breathe. Be.</h3>
<select class="med-duration" style="padding:10px;font-size:16px;border:1px solid #ccc;border-radius:4px;">
...
<button class="wm-btn wm-btn-primary med-start">🔔 Begin</button>
<button class="wm-btn med-stop">⏸ Pause</button>
</div>
<div class="med-circle" style="width:120px;height:120px;border-radius:50%;background:radial-gradient(circle,#B8960C22,#B8960C08);border:2px solid #B8960C;margin:1rem auto;display:flex;align-items:center;justify-content:center;">
<div class="med-display" style="font-size:28px;font-family:monospace;">10:00</div>
</div>
</div>
