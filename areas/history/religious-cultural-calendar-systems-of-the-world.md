---
title: "Religious & Cultural Calendar Systems of the World"
area: history
type: almanac
source: Observatory Almanac
source_path: docs/12-calendars-time/religious-calendars.md
license: MIT
updated: 2026-04-28
summary: >
...
1. **Tithi** — The lunar day (one of 30 in a lunar month), based on the angular relationship between the sun and moon. A tithi can be shorter or longer than a solar day.
2. **Vara** — The day of the week (named after celestial bodies, paralleling Western/Roman nomenclature).
3. **Nakshatra** — The lunar mansion — one of 27 (sometimes 28) star constellations through which the moon passes.
4. **Yoga** — One of 27 combinations of the sun's and moon's longitudes, each with its own character (auspicious to inauspicious).
5. **Karana** — Half of a tithi; there are 11 karanas, cycling through the month.
...
- **February 14 — Valentine's Day:** Originally a feast of St. Valentine (whose historicity is murky), now thoroughly secularized but retaining the name.
- **March 17 — St. Patrick's Day:** Apostle of Ireland; massive cultural celebration in Ireland and the Irish diaspora.
- **June 24 — Nativity of St. John the Baptist:** One of very few saints honored on their birth date.
- **June 29 — Sts. Peter and Paul:** Chief apostles.
- **August 15 — Assumption of Mary:** A major feast in Catholic and Orthodox traditions.
- **November 1 — All Saints' Day:** Commemorates all saints known and unknown. The eve (October 31) gave rise to Halloween.
- **November 2 — All Souls' Day:** Prayer for the faithful departed.
- **December 26 — St. Stephen:** First Christian martyr; "Feast of Stephen" in the carol Good King Wenceslas.
