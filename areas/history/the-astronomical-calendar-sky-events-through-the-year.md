---
title: "The Astronomical Calendar: Sky Events Through the Year"
area: history
type: almanac
source: Observatory Almanac
source_path: docs/12-calendars-time/astronomical-calendar.md
license: MIT
updated: 2026-04-28
summary: >
...
1. **New Moon:** The moon is between Earth and the sun; the illuminated face points away from us. The moon rises and sets with the sun — invisible to the naked eye. This is the darkest night.

2. **Waxing Crescent:** A thin sliver of light appears on the right (western) edge, visible just after sunset in the west. The rest of the moon is sometimes visible as "Earthshine" — sunlight reflected from Earth onto the unlit lunar surface.
...
5. **Full Moon:** The moon is opposite the sun; its entire face is illuminated. Rises at sunset, sets at sunrise — in the sky all night long. The full moon is 14× brighter than first quarter.
...
- **Planetary parade:** When several planets are visible simultaneously in the sky — rare to have 4–5 planets strung along the ecliptic.
...
**How to track:**
- **NASA Spot the Station:** spotthestation.nasa.gov — sign up for email/text alerts
- **Heavens-Above:** heavens-above.com — detailed pass predictions with sky charts
...
|-------|-------------|-----------------|
| 1 | Exceptional dark sky | Remote desert, high mountain | Zodiacal light casts shadows; M33 visible with direct vision |
| 2 | Truly dark sky | Remote wilderness | M33 easy; airglow visible on horizon |
| 3 | Rural sky | Remote farmland | Some light pollution on horizon; M33 fairly easy |
| 4 | Rural/suburban transition | Near small town | Zodiacal light visible in spring/fall |
| 5 | Suburban sky | Suburbs | Zodiacal light barely visible |
| 6 | Bright suburban sky | Dense suburbs | Only suggestion of zodiacal light |
| 7 | Suburban/urban transition | Near city | Sky is light gray at zenith |
| 8 | City sky | City | Entire sky is grayish-white; Milky Way invisible |
| 9 | Inner city sky | Downtown | Entire sky is gray; many stars invisible |
...
- **Dark Sky Sanctuaries** — the most pristine, remote sites
- **Dark Sky Parks and Reserves** — protected areas with excellent darkness
- **Dark Sky Communities** — towns that have adopted dark-sky ordinances
