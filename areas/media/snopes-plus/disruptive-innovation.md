...
In its degraded popular usage, "disruptive innovation" means something far vaguer: any new product, service, business model, or technology that changes how an existing industry operates, or simply anything that its creators wish to associate with the prestige of radical novelty. The gap between these two meanings—the precise theoretical construct and the promiscuous cultural label—is the subject of this review.
...
Clayton Christensen introduced "disruptive innovation" in *The Innovator's Dilemma: When New Technologies Cause Great Firms to Fail* (1997), building on earlier academic work with Joseph Bower in *Harvard Business Review* (1995). The theory had specific definitional boundaries:

- **Market entry point**: New entrants target overlooked, underserved, or non-consuming customer segments. The entrant's initial product is typically inferior to existing offerings on dimensions that mainstream customers value most.
- **Performance trajectory**: The entrant improves its offering over time along a trajectory that eventually meets mainstream requirements while maintaining cost or simplicity advantages.
- **Incumbent blindness**: Established companies rationally ignore the entrant because the initial target market is small, low-margin, and unattractive. Their own customers are not asking for the entrant's product.
- **Asymmetric motivation**: The critical mechanism is motivational asymmetry—the entrant is motivated to move upmarket into more profitable segments, while the incumbent is motivated to move further upmarket away from the low-margin space.

Christensen's classic examples—personal computers displacing mainframes, discount retailers displacing department stores, mini steel mills displacing integrated steel companies, digital cameras displacing film—all followed this specific pattern of low-end entry, performance improvement, and incumbent displacement through rational neglect.

**Theoretical Contribution: Genuine**
...
The most fundamental epistemological issue is the distinction between retrospective pattern recognition and prospective prediction. Christensen presented his framework as a predictive theory—a tool that managers could use to anticipate and respond to competitive threats before they materialized. But the theory's track record as a predictive instrument is weak.

Christensen's own public predictions illustrate the problem. In 2007, he predicted the iPhone would fail: "The prediction of the theory would be that Apple won't succeed with the iPhone... History speaks pretty loudly on that." The iPhone was a sustaining innovation by his definitions (a better phone for existing phone customers), and disruption theory predicted it would fail because sustaining innovations from new market entrants typically do. This prediction was spectacularly wrong, and its failure exposed a deeper issue: the theory worked better as a retrospective explanation of past competitive dynamics than as a guide to future outcomes.

A theory that can explain why Kodak failed but cannot predict whether Apple will succeed is performing a different epistemic function than it claims. The analytical authority of "disruptive innovation" in corporate strategy rests on its claimed predictive power. If that power is weak, the authority is borrowed from an empty account.

**The Prestige Degradation Cycle**

The transformation from academic concept to business jargon follows a pattern that recurs across management theory:

1. **Precise academic definition** with limited scope and explicit boundary conditions (Christensen 1995–1997)
2. **Popular adoption** driven by the concept's explanatory appeal—the story of scrappy upstarts defeating complacent giants resonates culturally (late 1990s–2000s)
3. **Definitional expansion** as practitioners apply the term beyond its scope because the label carries prestige (2005–2015)
4. **Complete semantic bleaching** as the term becomes a general-purpose descriptor for novelty (2015–present)
5. **Residual function** as tribal signaling, prestige marker, and marketing vocabulary—the word persists but performs social rather than analytical work

This cycle has occurred with "paradigm shift" (Kuhn's precise concept became a synonym for "change"), "synergy" (specific financial concept became empty corporate jargon), "ecosystem" (ecological concept became any network of related things), and "exponential" (mathematical function became synonym for "fast"). The pattern suggests that academic concepts whose explanatory narratives are culturally compelling are systematically vulnerable to semantic degradation.

**Management Consulting as Degradation Engine**

The consulting industry accelerated the concept's degradation by converting it from an analytical framework into a commercial product. "Disruption" became a service offering—companies could hire consultants to make them "more disruptive" or to defend against "disruption threats." Christensen himself co-founded Innosight, a consulting firm based on disruption theory, creating a commercial incentive to expand the theory's applicability.
...
"Disruptive innovation" merged with Silicon Valley's self-mythology to create an ideological framework justifying both genuine innovation and systematic regulatory evasion. The narrative structure: incumbents are complacent, regulations protect incumbents, disruption serves consumers by breaking through protections, therefore regulatory non-compliance is consumer advocacy.

This narrative performed real ideological work. When Uber violated taxi regulations, it was "disrupting" transportation. When Airbnb violated hotel regulations, it was "disrupting" hospitality. When cryptocurrency platforms operated outside financial regulation, they were "disrupting" banking. The "disruption" label transformed regulatory arbitrage—gaining competitive advantage by operating in regulatory gaps—into a story of innovation and consumer benefit.

Not all cases lacked genuine innovation. Uber improved the experience of urban transportation. Airbnb expanded accommodation options. But the "disruption" framework provided blanket justification that made it difficult to distinguish genuine innovation from regulatory evasion, labor exploitation, or the externalization of costs onto communities. When everything is "disruption," the term provides no analytical traction for distinguishing beneficial changes from extractive ones.

**The Gig Economy Connection**

The most consequential practical application of "disruption" ideology was the reclassification of employees as independent contractors across the gig economy. Companies including Uber, Lyft, DoorDash, and Instacart used "disruption" framing to redefine employment relationships, shifting healthcare costs, retirement benefits, equipment expenses, and insurance obligations from employers to workers. This wasn't market entry at the low end followed by upmarket movement—it was labor cost arbitrage justified by innovation rhetoric.

The economic research on gig economy labor outcomes paints a more complicated picture than either "disruption" advocates or labor critics present. Mishel (2018, Economic Policy Institute) found that the median Uber driver earned less than the minimum wage after accounting for vehicle expenses. But Hall and Krueger (2018) found that drivers valued schedule flexibility. The "disruption" label obscured rather than illuminated these trade-offs by framing a complex labor economics question as a simple innovation narrative.

**Academic Backlash and Alternative Frameworks**

Business school researchers increasingly challenged disruption theory's validity and offered alternatives:

- **Andrew King** (Dartmouth): Argued that the disruption paradigm fails empirically and has led companies to overreact to perceived threats while underinvesting in their core capabilities.
- **Joshua Gans** (University of Toronto): In *The Disruption Dilemma* (2016), argued that incumbent responses to disruption are more varied and more successful than Christensen's framework predicts.
- **Innovation ecosystem theories**: Adner's *The Wide Lens* (2012) argued that innovation success depends more on ecosystem dynamics than on whether an innovation fits the "disruptive" pattern.

The folk equivalent of "disruptive innovation"—"game-changer"—is honestly imprecise. It simply means "importantly different" without claiming predictive frameworks or academic backing. Its very lack of theoretical pretension makes it a more honest descriptor for most cases where "disruptive" is applied.

**The Post-Christensen Landscape**

Christensen's death in January 2020 removed the theory's primary guardian and most authoritative voice. Without Christensen to protest misapplication, the term's popular meaning has fully detached from its theoretical origins. "Disruption" now functions as a permanent feature of business vocabulary—as ubiquitous and as analytically empty as "synergy" before it.
