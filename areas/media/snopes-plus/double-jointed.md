...
The term "double-jointed" is itself a misnomer that has persisted in popular usage despite its anatomical inaccuracy. Medical professionals prefer "joint hypermobility" or "ligamentous laxity" to describe the condition more precisely. The folk terminology creates confusion by implying a structural difference where none exists.

**The Hypermobility Spectrum**: Joint hypermobility affects approximately 10-25% of the population, with significant variation based on age, gender, and ethnicity. The Beighton Score, developed by Beighton, Solomon, and Soskolne in 1973, remains the standard clinical assessment for generalized joint hypermobility. This nine-point scale evaluates flexibility at specific joints: thumbs, fifth fingers, elbows, knees, and spinal forward flexion. A score of 5 or above in adults (4 or above in individuals over 50) is generally considered indicative of generalized hypermobility.
...
**Connective Tissue Biology**: Hypermobility primarily results from variations in collagen composition and structure. Collagen, the most abundant protein in the human body, provides structural integrity to ligaments, tendons, joint capsules, and other connective tissues. Genetic variations affecting collagen synthesis, cross-linking, or degradation can result in increased tissue elasticity and joint mobility. There are at least 28 types of collagen, but types I, III, and V are most relevant to joint mobility and connective tissue integrity.

The most significant development in hypermobility research came with the recognition of Ehlers-Danlos Syndrome (EDS) and Joint Hypermobility Syndrome (JHS) as serious medical conditions rather than mere party tricks. Castori et al. (2017) outlined the EDS-JHS spectrum, demonstrating that what appears as harmless flexibility can actually indicate systemic connective tissue dysfunction. The 2017 international classification recognized 13 subtypes of EDS, each with distinct genetic and clinical profiles, though hypermobile EDS (hEDS) remains the most common and the most difficult to diagnose due to the absence of a confirmatory genetic test.

**Gender and Hormonal Factors**: Women are significantly more hypermobile than men, a difference that becomes pronounced after puberty. Estrogen affects collagen metabolism, increasing tissue elasticity during certain phases of the menstrual cycle and dramatically during pregnancy. Relaxin, a hormone produced primarily during pregnancy, further increases ligament laxity to facilitate childbirth, but can exacerbate symptoms in women with underlying connective tissue disorders.

Research by Remvig et al. (2007) demonstrated that hormonal contraceptives can also influence joint hypermobility, with some women experiencing increased symptoms while on certain formulations. These findings highlight the complex interplay between hormones and connective tissue that the "extra joints" explanation completely fails to capture. The hormonal dimension also helps explain why hypermobility-related conditions are diagnosed far more frequently in women, contributing to historical patterns of medical dismissal.
...
**Diagnostic Challenges**: The medical community has historically struggled with hypermobility-related conditions, partly due to the complexity of symptoms and the lack of definitive diagnostic tests. Unlike conditions with clear biomarkers, hypermobility disorders rely on clinical assessment and patient history. The situation is further complicated by the fact that hypermobility naturally decreases with age, meaning that older patients may no longer meet Beighton score thresholds despite having lifelong connective tissue dysfunction.

The Brighton Criteria, developed in 1998 and refined multiple times since, attempt to standardize diagnosis of Joint Hypermobility Syndrome. However, the criteria remain somewhat subjective, and many healthcare providers lack sufficient training in recognizing pathological hypermobility. This diagnostic uncertainty is compounded by the folk belief that hypermobility is always benign—the "double-jointed" framing suggests there's nothing medically significant to investigate.

**Genetic Research**: Recent genetic research has identified several genes associated with connective tissue disorders and hypermobility. Mutations in COL5A1, COL5A2, COL1A1, and TNXB have been linked to various forms of Ehlers-Danlos syndrome. However, many cases of symptomatic hypermobility do not show identifiable genetic mutations, suggesting additional mechanisms yet to be discovered. The genetic architecture of hEDS, in particular, remains elusive despite being the most common subtype.

The genetic complexity of hypermobility disorders contrasts sharply with the simple "extra joints" explanation. As Malfait et al. (2017) demonstrated in their comprehensive review, the molecular basis of these conditions involves intricate interactions between multiple genetic pathways affecting collagen synthesis, processing, and function. Ongoing genome-wide association studies aim to identify common variants that contribute to the hypermobility spectrum, which could eventually enable earlier identification and preventive management.
