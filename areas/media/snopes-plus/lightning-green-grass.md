...
The claim appears in various forms across cultures and generations: gardeners who swear by "thunderstorm water" for their plants, farmers who notice improved crop growth after electrical storms, and the widespread belief that post-storm landscapes appear more vibrant and lush. Some versions specify that you should water plants with rainwater collected during thunderstorms, while others simply assert that lightning-accompanied rain is somehow superior to ordinary precipitation.
...
The energy in a lightning bolt—approximately 1-5 billion joules—breaks apart nitrogen molecules (N₂) in the atmosphere. These liberated nitrogen atoms combine with oxygen to form nitrogen oxides (NO and NO₂), which dissolve in rainwater to create nitrate and nitrite ions. This natural fertilizer then falls to earth in post-storm precipitation.

**Quantitative Significance**: Noxon (1976) provided the first systematic estimate of global lightning nitrogen fixation, calculating 2-20 teragrams of nitrogen per year. This range reflected the difficulty of measuring a process that occurs sporadically across the entire planet. Subsequent research by Schumann and Huntrieser (2007) refined this estimate to 2-8 teragrams annually, using improved global lightning detection networks and atmospheric modeling.

To put these numbers in perspective, lightning accounts for approximately 5-8% of total global nitrogen fixation—a substantial contribution to the nitrogen cycle. This places atmospheric electrical fixation in the same order of magnitude as industrial nitrogen fixation through the Haber-Bosch process, though well below biological nitrogen fixation by soil bacteria and root nodule symbionts.

**Bioavailability and Plant Response**: The nitrate produced by lightning is immediately bioavailable to plants, unlike organic nitrogen compounds that require microbial processing. Post-thunderstorm rain typically contains 2-10 milligrams of nitrate per liter, compared to less than 1 milligram per liter in ordinary precipitation. This represents a significant pulse of readily absorbable plant nutrients.
...
Three major processes accomplish this conversion: biological fixation (primarily by bacteria), industrial fixation (the Haber-Bosch process), and atmospheric fixation (lightning). Each operates on different scales and timescales, but all contribute to the nitrogen available for plant growth.

**Biological Nitrogen Fixation**: Soil bacteria, particularly Rhizobium species in root nodules of leguminous plants, account for the largest fraction of global nitrogen fixation—approximately 100-200 teragrams per year. This process occurs continuously but varies seasonally and geographically based on soil conditions, plant communities, and climate factors.

The symbiotic relationship between plants and nitrogen-fixing bacteria represents one of biology's most important partnerships. Without this biological process, terrestrial ecosystems would be severely nitrogen-limited, and agricultural productivity would be dramatically reduced.

**Industrial Nitrogen Fixation**: The Haber-Bosch process, developed in the early 20th century, converts atmospheric nitrogen to ammonia for fertilizer production. This industrial process now fixes approximately 100-150 teragrams of nitrogen annually, comparable to biological fixation.

Fritz Haber and Carl Bosch's innovation arguably represents the most important chemical process of the modern era, enabling the agricultural productivity that supports current global population levels. However, the energy requirements are enormous—the Haber-Bosch process consumes roughly 1% of global energy production.

**Lightning's Unique Contribution**: While lightning fixes less nitrogen globally than biological or industrial processes, its contribution has unique characteristics. Lightning fixation occurs primarily in tropical and subtropical regions with high thunderstorm frequency, delivering nitrogen pulses precisely when and where plants need them most—during growing seasons in warm, humid climates.
...
Modern precision agriculture increasingly recognizes the value of natural nutrient cycling processes. Integrated nutrient management approaches attempt to optimize the timing and application of synthetic fertilizers to complement rather than overwhelm natural nitrogen fixation processes.

**Climate Change Considerations**: Global climate change affects thunderstorm patterns and intensity, with implications for lightning nitrogen fixation. Romps et al. (2014) predicted that lightning frequency could increase by 12% per degree of global warming, potentially increasing atmospheric nitrogen fixation in some regions while decreasing it in others.

The shifting distribution of thunderstorm activity could alter regional nitrogen budgets, affecting ecosystem productivity and agricultural systems that have evolved to depend on lightning-fixed nitrogen inputs. Some tropical regions that currently benefit from frequent electrical storms might experience reduced lightning activity, while other areas could see increases.

**Environmental Complexity**: The interaction between lightning nitrogen fixation and ecosystem processes involves numerous feedback loops and complications. Increased nitrogen availability can alter plant community composition, favoring species that respond strongly to nitrogen inputs while potentially disadvantaging others.

In nitrogen-limited ecosystems, lightning fixation might represent a significant portion of total nitrogen inputs. However, in ecosystems that are phosphorus-limited or water-limited, additional nitrogen might have minimal impact on plant growth. The ecological significance of lightning fixation depends critically on local environmental conditions and ecosystem characteristics.

**Seasonal and Geographic Variation**: Lightning activity varies dramatically by season and geographic region, creating corresponding patterns in atmospheric nitrogen fixation. Tropical regions with year-round thunderstorm activity receive steady inputs of lightning-fixed nitrogen, while temperate regions experience seasonal pulses that coincide with summer growing seasons.

This temporal and spatial variation helps explain why the folk belief about lightning making grass greener is more prevalent in some regions than others. Areas with frequent summer thunderstorms would show more obvious responses to lightning nitrogen fixation than regions with infrequent electrical activity or winter-dominant precipitation patterns.

**Measurement Challenges**: Quantifying the effects of lightning nitrogen fixation on plant growth remains technically challenging. The nitrogen pulse from individual storms is relatively small compared to background soil nitrogen pools, and separating lightning effects from other factors affecting plant growth requires sophisticated experimental designs.

Field studies must account for numerous confounding variables: soil moisture changes from accompanying rainfall, temperature effects, mechanical damage from wind and hail, and variation in storm intensity and duration. Despite these challenges, carefully controlled studies have consistently documented measurable plant responses to lightning-enhanced precipitation.

**Technological Applications**: Understanding lightning nitrogen fixation has inspired research into artificial nitrogen fixation technologies that mimic natural electrical processes. Plasma-based nitrogen fixation systems attempt to replicate the high-energy conditions in lightning strikes to produce fertilizer nitrogen more efficiently than traditional Haber-Bosch processes.
