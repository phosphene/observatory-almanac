...
The narrative typically proceeds as follows: the human digestive system is inefficient, modern food processing has reduced nutrient density, cooking destroys nutrients, and the combination of these factors means that even healthy diets provide insufficient nutrition. Therefore, concentrated supplements are presented as necessary to compensate for these systematic nutritional shortfalls.
...
Iron absorption varies from 10-35% depending on form (heme vs. non-heme), dietary cofactors (vitamin C enhances absorption), and individual iron status (absorption increases when stores are low). Claiming "10-20%" for iron ignores this adaptive regulation.

Calcium absorption ranges from 30-40% from most food sources, with significant variation based on vitamin D status, age, and simultaneous intake of oxalates or phytates. Dairy products, leafy greens, and fortified foods show different absorption patterns.

Zinc absorption averages 20-40% but varies enormously based on phytate content, protein source, and zinc status. The body regulates zinc absorption based on physiological need.

Water-soluble vitamins show much higher absorption rates: Vitamin C absorption is 70-90% at moderate doses (decreasing at very high doses), B vitamins are generally well-absorbed from food sources, and folate absorption from food is actually better than from supplements in many cases.

Fat-soluble vitamins (A, D, E, K) require dietary fat for absorption but are efficiently absorbed when consumed with appropriate food matrices. Vitamin D absorption from food can exceed 80% when consumed with fat.

**The Evolutionary Argument**: The claim that human digestion is inherently inefficient contradicts basic evolutionary biology. The gastrointestinal tract represents approximately 70% of the immune system and consumes about 20% of metabolic energy at rest. An organ system that consumes this much energy while failing to extract nutrients efficiently would represent a massive evolutionary disadvantage.

Human digestive physiology shows multiple adaptations for nutrient extraction: stomach acid for protein denaturation and mineral solubilization, pancreatic enzymes for macronutrient breakdown, bile acids for fat emulsification, and specialized transport systems for different nutrients. The small intestine's surface area is approximately 250-400 square meters due to villi and microvilli—an enormous surface optimized for absorption.

**Food Matrix Effects**: Nutrients in whole foods often show superior bioavailability compared to isolated supplements due to synergistic compounds, proper ratios, and food matrix effects. Lycopene from tomatoes is better absorbed when tomatoes are cooked with oil. Calcium from dairy products is more bioavailable than calcium carbonate supplements. Iron from meat sources (heme iron) is more readily absorbed than iron from supplements.
...
Population-level nutritional surveillance data contradicts the "poor absorption" narrative. The NHANES (National Health and Nutrition Examination Survey) data shows that most Americans meet or exceed recommended intakes for most nutrients from food alone. Deficiencies are typically related to dietary patterns (insufficient fruit and vegetable consumption) rather than absorption failure.

The supplement industry's growth trajectory—from $4 billion in 1994 to over $150 billion globally in 2023—corresponds more closely with marketing expansion and regulatory changes than with evidence of increasing nutritional inadequacy. This pattern suggests commercial rather than scientific drivers of supplement consumption.
...
**Economic Impact**: Americans spend approximately $50 billion annually on vitamins and supplements, with much of this spending justified by claims about dietary inadequacy. If food-based nutrition is generally adequate for most people, this represents substantial misallocation of healthcare spending.

**Opportunity Cost**: Money spent on supplements often represents opportunity cost for higher-quality food. For many consumers, the cost of supplement regimens could purchase more nutrient-dense foods (organic produce, grass-fed meat, wild fish) that provide superior nutrition with better bioavailability.

**Regulatory Capture**: The supplement industry's political influence has created regulatory frameworks that prioritize market access over consumer protection. The 1994 DSHEA legislation was heavily influenced by supplement industry lobbying and created the current environment where absorption claims can be made without supporting evidence.

**Medical Iatrogenesis**: Excessive supplementation can cause harm through nutrient interactions, overdose, and false reassurance. High-dose vitamin E supplements increase mortality risk. Beta-carotene supplements increase lung cancer risk in smokers. Iron supplements can cause gastrointestinal problems and mask underlying bleeding. The "more is better" mentality encouraged by poor absorption claims can lead to harmful overconsumption.

**Diagnostic Overshadowing**: Focus on alleged absorption problems can distract from actual causes of nutritional inadequacy: poverty, food access, eating disorders, medical conditions affecting digestion, or simply poor dietary choices. Treating imaginary absorption problems with supplements may delay addressing real nutritional issues.

**Environmental Impact**: The supplement industry has substantial environmental costs: manufacturing, packaging, shipping, and disposal of products that may provide no benefit. Nutrient extraction from natural sources (fish oil, plant extracts) can contribute to environmental degradation. If dietary nutrition is adequate, these environmental costs represent pure waste.

**Global Health Equity**: Supplement marketing in developing countries often promotes expensive products to populations with real food insecurity. The "poor absorption" narrative can redirect resources from basic nutritional needs (adequate calories, protein, essential nutrients from food) toward supplemental products that provide marginal or no benefit.

**Healthcare Provider Training**: The persistence of absorption myths affects healthcare provider recommendations. Practitioners without strong nutrition training may accept industry claims about supplement necessity, leading to inappropriate recommendations and missed opportunities to address actual dietary issues.

**Scientific Literacy**: The supplement industry's marketing practices contribute to broader problems with scientific literacy and evidence evaluation. Consumers who accept absorption claims without evidence may be more susceptible to other forms of health misinformation.

**Food System Implications**: Claims that food-based nutrition is inadequate can undermine support for policies promoting food access, agricultural diversity, and food system sustainability. If supplements can replace dietary nutrition, there's less incentive to address problems with food production and distribution.

**Cultural Attitudes Toward Food**: The "poor absorption" narrative contributes to medicalization of eating, where food is viewed primarily as a delivery vehicle for nutrients rather than a source of pleasure, culture, and social connection. This can contribute to disordered eating patterns and anxiety around food choices.

**Research Prioritization**: Industry funding directed toward supplement research may divert resources from more important nutritional research: food access interventions, dietary pattern studies, or addressing specific nutritional needs in vulnerable populations.

**Insurance and Healthcare Costs**: As supplement use increases based on absorption claims, healthcare costs may increase through unnecessary testing (nutrient level monitoring), treatment of supplement-related adverse effects, and opportunity costs of addressing imaginary rather than real health problems.

**Consumer Protection**: The current regulatory environment provides limited protection for consumers making decisions based on absorption claims. Unlike pharmaceutical advertising, supplement marketing faces minimal oversight for accuracy or evidence requirements.

**Professional Ethics**: Healthcare practitioners face ethical dilemmas when patients request supplements based on absorption myths. Balancing patient autonomy, evidence-based practice, and commercial influences requires clear professional guidance that currently may be lacking.
