...
Variations of the claim include: "opposites attract and stay together," "different personalities make relationships more exciting," "complementary traits create stronger bonds," and "diversity in couples prevents boredom." The belief often extends to specific domains: introverts should pair with extroverts, organized people with spontaneous ones, logical thinkers with emotional feelers.
...
- Complementary skills can benefit relationship functioning
- Novel experiences and perspectives can enhance relationship satisfaction
- Initial attraction sometimes occurs across difference dimensions

**Distorted or overgeneralized components:**
- Systematic research shows similarity as the dominant attraction pattern
- Long-term relationship success correlates with similarity, not difference
- Complementarity effects are limited to narrow domains
- The claim conflates initial attraction with relationship sustainability
...
**Attitude and value similarity:** Donn Byrne's foundational 1971 research established the similarity-attraction paradigm through controlled experiments. Participants consistently rated similar others as more attractive, likeable, and desirable as relationship partners. This effect proved robust across different attitude domains, cultural groups, and measurement approaches.

**Meta-analytic confirmation:** Montoya, Horton, and Kirchner's 2008 meta-analysis examining 313 studies found consistent evidence for similarity effects in attraction. Both actual similarity (measured objectively) and perceived similarity predicted attraction, with actual similarity showing stronger effects for established relationships versus initial encounters.

**Longitudinal relationship outcomes:** Luo and Klohnen's 2005 study of newlyweds found that couples were highly similar on attitudes, values, and religiosity at marriage. Personality similarity had no effect on relationship satisfaction over time, while dissimilarity on core values predicted decreased satisfaction. The study found no evidence that personality complementarity enhanced relationship outcomes.

**Comprehensive domain analysis:** Research demonstrates similarity effects across multiple relationship-relevant domains:
- **Demographic characteristics:** Age, education, socioeconomic status, race, and religion
- **Attitudes and values:** Political views, religious beliefs, lifestyle preferences, life goals
- **Personality traits:** Conscientiousness, emotional stability, openness to experience
- **Behavioral patterns:** Activity preferences, social habits, communication styles

**The limited domain of complementarity effects:** Research has identified one narrow area where complementarity may benefit relationships: dominance-submissiveness dynamics. Dryer and Horowitz's 1997 research suggested that relationships function better when partners have complementary positions on dominance hierarchies rather than competing for the same level.

However, even this finding is limited in scope and doesn't extend to other personality dimensions or relationship domains. The dominance complementarity effect represents a narrow exception to the broader similarity pattern, not evidence for general opposites attraction.

**Explanatory mechanisms for similarity effects:**
- **Validation and reinforcement:** Similar others validate our beliefs, values, and preferences, providing psychological comfort and self-esteem enhancement
- **Predictability and understanding:** Similarity facilitates communication, empathy, and behavioral prediction, reducing relationship stress and conflict
- **Shared activities and interests:** Similar preferences enable enjoyable shared experiences and compatible lifestyle choices
- **Social network integration:** Similar partners are more likely to be accepted by each other's social circles, reducing external relationship pressures

**Why the "opposites attract" belief persists despite contrary evidence:**

**Hollywood and media narratives:** Popular culture consistently portrays opposite-personality couples as more dramatically interesting, romantically compelling, and ultimately successful. Movies and television shows favor difference-based couples because similarity creates less narrative tension and character development opportunities.

**Confirmation bias and selective attention:** People notice and remember instances where apparent opposites attract while overlooking the more common similar couples around them. Dramatic difference-based relationships are more memorable and discussable than typical similar partnerships.

**Early relationship novelty effects:** Initial attraction to different others may occur because novelty is inherently interesting and stimulating. However, research suggests this novelty effect fades over time, while similarity-based compatibility becomes more important for relationship maintenance.
...
**Evolutionary psychology perspectives:** From an evolutionary standpoint, both similarity and difference preferences make adaptive sense depending on the context. Similarity in values and goals facilitates cooperation and coordinated parenting efforts. However, some degree of genetic diversity (difference) benefits offspring health and adaptability.

This creates a potential tension between psychological attraction mechanisms (favoring similarity) and reproductive success factors (sometimes favoring difference). However, research suggests that psychological similarity and genetic diversity are largely independent—you can be psychologically similar to someone while being genetically diverse.

**Assortative mating patterns:** Large-scale demographic research consistently demonstrates assortative mating—the tendency for similar individuals to pair together—across virtually all measurable characteristics. This pattern appears across cultures, historical periods, and social systems, suggesting fundamental rather than culturally specific processes.

The strength of assortative mating has increased over recent decades in many societies, particularly for education and socioeconomic status. This trend may reflect increased opportunities for similar individuals to meet (college, professional networks, online dating algorithms) and decreased social pressure for economically motivated marriages.

**Online dating and algorithm design:** Modern dating platforms face the challenge of implementing attraction algorithms based on either similarity or difference assumptions. Most successful platforms (Match, eHarmony, OkCupid) have converged on similarity-based matching algorithms after testing both approaches.
...
**Personality complementarity research nuances:** While general personality complementarity doesn't predict relationship success, some research suggests more nuanced patterns may exist. For example, anxiously attached individuals may initially be drawn to avoidantly attached partners, though these pairings typically prove unstable over time.

The attachment research illustrates how initial attraction patterns (opposites may attract) can differ from long-term compatibility patterns (similar attachment styles predict better outcomes). This distinction helps explain why people may have personal experiences of opposite-attraction while research shows similarity benefits.

**Social psychology of attraction myths:** The persistence of the opposites attract belief despite contrary evidence illustrates broader patterns in how people process social science information. Romantic beliefs are particularly resistant to disconfirming evidence because:

- Personal relationship experiences feel more compelling than statistical patterns
- Romantic ideologies serve identity and meaning-making functions beyond accuracy
- The entertainment industry continuously reinforces attractive but false relationship narratives
- Individual differences mean some people do experience attraction across differences, even if it's statistically uncommon

**Implications for relationship advice and education:** Understanding the similarity-attraction research has practical implications for dating strategies, relationship counseling, and marriage preparation programs. Evidence-based approaches would emphasize:

- Seeking partners with similar core values and life goals
- Recognizing that initial excitement about differences may fade over time
- Developing shared interests and activities as relationship investments
- Addressing value conflicts early rather than assuming they'll resolve through complementarity
