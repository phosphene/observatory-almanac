---
title: "Vedic Astrology: Jyotisha — The Science of Light"
area: philosophy
type: almanac
source: Observatory Almanac
source_path: docs/09-oracles-parlor/vedic-astrology.md
license: MIT
updated: 2026-04-28
summary: >
  The stars do not compel — they illuminate. Jyotisha, the ancient Hindu science of light, reads the celestial map of one's birth not as a prison sentence but as a detailed terrain guide.
tags:
  - divination
  - astrology
  - philosophy
...
**Quality (Guna) designations:**
- **Deva** — Divine, virtuous, spiritually oriented
- **Manushya** — Human, balanced, worldly-spiritual mix
- **Rakshasa** — Demonic, intense, powerful but potentially destructive
...
Each planet rules a dasha of a specific duration:
| Planet | Duration |
|--------|----------|
| Ketu | 7 years |
...
<div id="vedic-tool" class="wm-tool">
<h3>Quick Reading — Birth Date</h3>
<p>Enter your birth date for your approximate Moon sign and Nakshatra:</p>
<div style="display:grid;gap:12px;max-width:400px;">
<label>Birth Date:
<input type="date" class="vedic-date" style="display:block;padding:8px;font-size:16px;border:1px solid #ccc;border-radius:4px;width:100%;margin-top:4px;"></label>
</div>
<button class="wm-btn wm-btn-primary vedic-calc" style="margin-top:12px;">🌙 Find My Nakshatra</button>
<div class="vedic-result" style="margin-top:16px;"></div>

<details style="margin-top:1.5rem;">
<summary class="wm-btn" style="cursor:pointer;">🔭 For precise Nakshatra, add birth time & place</summary>
<div style="margin-top:12px;padding:16px;background:var(--md-code-bg-color);border-radius:8px;">
<p><strong>Vedic astrology requires precise Moon position.</strong> Birth time and place let us calculate which Nakshatra (lunar mansion) the Moon occupied at your birth.</p>
<div style="display:grid;gap:12px;max-width:400px;">
<label>Birth Time:
<input type="time" class="vedic-time" style="display:block;padding:8px;font-size:16px;border:1px solid #ccc;border-radius:4px;width:100%;margin-top:4px;"></label>
<label>Birth City:
<input type="text" class="vedic-city" placeholder="e.g. Chennai, Kathmandu, Colombo" style="display:block;padding:8px;font-size:16px;border:1px solid #ccc;border-radius:4px;width:100%;margin-top:4px;"></label>
</div>
<button class="wm-btn wm-btn-primary vedic-calc-full" style="margin-top:12px;">🌙 Calculate Precise Nakshatra</button>
<div class="vedic-full-result" style="margin-top:16px;"></div>
<p style="font-size:13px;color:#888;margin-top:12px;"><em>In Vedic astrology (Jyotish), your Moon sign and Nakshatra are more important than your Sun sign. The Moon moves through one Nakshatra roughly every day, so birth time matters greatly. Without time, we estimate based on the Moon's average position for your birth date.</em></p>
</div>
</details>
</div>
