---
title: "Western Astrology: A Complete Guide"
area: philosophy
type: almanac
source: Observatory Almanac
source_path: docs/09-oracles-parlor/western-astrology.md
license: MIT
updated: 2026-04-28
summary: >
...
<ul>
<li><a href="../i-ching/#cast-the-i-ching-now">🎲 I Ching Oracle</a></li><li><a href="../tarot-guide/#draw-cards-now">🎴 Tarot Draw</a></li><li><strong>☀️ Sun Sign Finder</strong> (this page)</li><li><a href="../chinese-zodiac/#find-your-animal">🐉 Chinese Zodiac</a></li><li><a href="../geomancy/#cast-the-figures">⚁ Geomancy Cast</a></li>
</ul>
</details>
...
The zodiac is a belt of sky approximately 18° wide centered on the ecliptic — the apparent path of the Sun through the heavens over the course of a year. The zodiac is divided into twelve equal 30° segments, each associated with a constellation. In **tropical astrology** (the dominant Western system), these signs are fixed to the seasons rather than the actual star positions — the vernal equinox always marks the beginning of Aries, regardless of where the constellation Aries actually appears in the sky.
...
Fixed earth: the immovable, the permanent, the sensual. Taurus governs the material world in all its beauty and solidity — food, music, physical comfort, the pleasures of the senses. Taurus individuals tend to be patient, persistent, reliable, and deeply attached to security and comfort. They build slowly and enduringly. Their relationship to beauty — visual, culinary, musical — is often highly developed.
...
Cardinal earth: the initiating, goal-oriented, structural earth. Capricorn governs ambition, authority, discipline, career, tradition, and the long view of time. Capricorn individuals are often highly disciplined, practical, and ambitious — willing to work long and hard toward significant goals. They respect structure and earned authority.
...
Fixed air: the committed idea, the principle, the idealistic intellect. Aquarius governs innovation, humanitarianism, community, revolution, and the future. Aquarius individuals are often intellectually innovative and possessed of a genuine concern for humanity in the abstract — sometimes at the expense of intimacy with individuals in particular.
...
The birth chart — the horoscope — is divided into twelve houses, each governing a specific domain of life. The houses are determined by the time and place of birth, as they depend on the exact position of the horizon at the moment of birth.
...
Aspects are the angular relationships between planets in a chart. They are the grammar of astrological interpretation — they describe how the energies symbolized by different planets interact.

**Conjunction (0°):** Blending of energies. Intensification. The planets act together. Can be harmonious or tense depending on the planets involved.

**Opposition (180°):** Tension, polarity, the need for integration. Two planets pulling in opposite directions, seeking balance.

**Trine (120°):** Natural harmony and ease. Talents that flow effortlessly. The blessing aspect — though sometimes indicating energy that is taken for granted.

**Square (90°):** Friction, challenge, the drive to overcome obstacles. Often associated with significant achievement through struggle.

**Sextile (60°):** Opportunity, potential. Like the trine but requiring more conscious engagement to activate.

**Quincunx/Inconjunct (150°):** Adjustment, awkwardness. Two energies that don't naturally speak the same language and require constant recalibration.

**Semi-square (45°) and Sesquiquadrate (135°):** Minor friction aspects. Smaller but persistent irritants.
...
*Astrology does not determine. It illuminates. The wise engagement with any symbolic system is not to be told what will happen but to expand one's understanding of what might be, and why. The stars, as Shakespeare observed, do not hold us in thrall — but they may, for those who learn to read them, offer a language for what we already sense in the deep currents of our own becoming.*

---
## ☀️ Your Birth Chart

<div id="astrology-tool" class="wm-tool">
<h3>Quick Reading — Just Your Birthday</h3>
<p>Enter your birth date for your Sun Sign:</p>
<input type="date" class="astro-date" style="padding:10px;font-size:16px;border:1px solid #ccc;border-radius:4px;">
<button class="wm-btn wm-btn-primary astro-calc" style="margin-left:8px;">☀️ Find My Sun Sign</button>
<div class="astro-result" style="margin-top:16px;"></div>

<details style="margin-top:1.5rem;">
<summary class="wm-btn" style="cursor:pointer;">🔭 Want more precision? Add birth time & place</summary>
<div style="margin-top:12px;padding:16px;background:var(--md-code-bg-color);border-radius:8px;">
<p><strong>For a more complete reading, add:</strong></p>
<div style="display:grid;gap:12px;max-width:400px;">
<label>Birth Time (for Rising Sign / Ascendant):
<input type="time" class="astro-time" style="display:block;padding:8px;font-size:16px;border:1px solid #ccc;border-radius:4px;width:100%;margin-top:4px;"></label>
<label>Birth City (for house placements):
<input type="text" class="astro-city" placeholder="e.g. New York, London, Mumbai" style="display:block;padding:8px;font-size:16px;border:1px solid #ccc;border-radius:4px;width:100%;margin-top:4px;"></label>
</div>
<button class="wm-btn wm-btn-primary astro-calc-full" style="margin-top:12px;">🔭 Calculate Full Chart</button>
<div class="astro-full-result" style="margin-top:16px;"></div>
<p style="font-size:13px;color:#888;margin-top:12px;"><em>Birth time determines your Rising Sign (Ascendant) — the mask you wear in public and how others first perceive you. Without it, we can only show your Sun Sign. Birth city helps with house placements. The more data, the more precise the reading.</em></p>
</div>
</details>
</div>
