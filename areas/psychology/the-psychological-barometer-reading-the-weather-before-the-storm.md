---
title: "The Psychological Barometer: Reading the Weather Before the Storm"
area: psychology
type: almanac
source: Observatory Almanac
source_path: docs/05-soul-and-mind/psychological-barometer.md
license: MIT
updated: 2026-04-28
summary: >
...
## Allostatic Load: The Body Keeps Score
...
- Immune dysregulation (frequent illness, autoimmune flares)
- Hippocampal shrinkage and memory problems
...
## Burnout: Stages and Recognition
...
Work crowds out everything else. Relationships that were once central become peripheral. Social commitments feel like burdens. Previously meaningful activities feel hollow.

**Stage 6: Denial of Emerging Problems**
Cynicism, intolerance, and aggression increase. Others are perceived as demanding, incompetent, or ungrateful. The individual feels threatened by any acknowledgment of struggle.
...
Christina Maslach's research identified three dimensions of burnout, measured by the Maslach Burnout Inventory:

1. **Emotional exhaustion**: Depleted emotional resources; the sense that one has nothing left to give
2. **Depersonalization/cynicism**: Detachment from work, colleagues, or clients; treating people as objects rather than humans
3. **Reduced personal accomplishment**: Loss of the sense that one's work is effective or meaningful

This framework distinguishes burnout from simple fatigue or stress. You can be exhausted without burning out. Burnout involves a specific hollowing-out of meaning and connection, not just depletion of energy.

---

## Self-Assessment: The Psychological Barometer Checklists

### Early Warning Signs Checklist

Rate each item: 0 (not present), 1 (mild/occasional), 2 (moderate/frequent), 3 (severe/constant)

**Physical Domain**
- [ ] Sleep quality has declined; trouble falling or staying asleep
- [ ] Waking unrefreshed regardless of hours slept
- [ ] Increased frequency of illness (colds, infections)
- [ ] Persistent tension headaches or back/neck pain
- [ ] Digestive problems without clear medical cause
- [ ] Fatigue that doesn't improve with rest
- [ ] Increased reliance on caffeine, alcohol, or stimulants
...
**Emotional Domain**
- [ ] Increased irritability, particularly over minor issues
- [ ] Emotional flatness or numbness
- [ ] Anxiety or dread at the prospect of work/obligations
- [ ] Loss of satisfaction in activities that were previously rewarding
- [ ] Increased cynicism about people, work, or the future
- [ ] Feeling trapped, resentful, or depleted
...
## Moral Injury: When What You Do Violates Who You Are

Moral injury is distinct from burnout, though they often co-occur. First described in veterans by Jonathan Shay and later theorized by Brett Litz and colleagues, **moral injury** is the psychological damage that results from perpetrating, witnessing, or failing to prevent actions that violate one's moral framework.

Key moral injury scenarios in non-combat contexts:
- Healthcare workers forced to provide inadequate care due to systemic resource constraints
- Teachers mandated to implement practices they believe harm students
...
- Intrusive imagery or thoughts about clients'/patients'/loved ones' suffering
- Hypervigilance and heightened startle response
- Emotional numbing as protective adaptation
- Dread or aversion toward work that was previously meaningful
- Difficulty separating one's own distress from that of those one cares for
- Reduced capacity for empathy ("compassion satisfaction" depleted)

**Prevention and recovery**:
- Deliberate boundary maintenance between professional and personal life
- Regular supervision, consultation, or peer support (particularly for professionals)
- Somatic self-care: physical practices that discharge accumulated tension
- Meaning-maintenance: reconnecting to the reasons you chose this work
- Recognizing vicarious trauma as occupational risk, not personal weakness
...
When assessing your work environment, examine:
- Are demands proportionate to time and resources available?
- Do you have meaningful control over how you do your work?
- Is your contribution recognized and valued?
- Is there genuine social support among colleagues, or competitive isolation?
- Does your work align with your values, or regularly violate them (moral injury risk)?
...
## Conclusion: The Courage of Self-Awareness
...
- Emily & Amelia Nagoski, *Burnout: The Secret to Unlocking the Stress Cycle* (2019)
