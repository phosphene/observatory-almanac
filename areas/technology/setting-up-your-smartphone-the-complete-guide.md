---
title: "Setting Up Your Smartphone — The Complete Guide"
area: technology
type: almanac
source: Observatory Almanac
source_path: docs/22-digital-life/smartphone-setup.md
license: MIT
updated: 2026-04-28
summary: >
  Getting a new phone is exciting, and a little overwhelming. Whether it's an iPhone or an Android, there's a right way to set it up that will save you headaches for years.
tags:
  - technology
  - digital
  - practical
...
## Initial Setup: Turning It On for the First Time

### Powering On
Press and hold the power button (usually on the right side or top) until you see the logo. On iPhone, you'll see an Apple. On Android, you'll see whatever the manufacturer's logo is, then the Google logo.
...
### Connecting to WiFi
**You need WiFi before you can do almost anything else.**
...
This is the most important step. Your account is the key to everything on your phone.

### iPhone: Creating an Apple ID

If you don't already have an Apple ID, you'll be prompted to create one. Your Apple ID is an email address and password that unlocks the App Store, iCloud backup, Find My iPhone, FaceTime, and iMessage.
...
### Android: Creating a Google Account (or Signing In)

Your Android phone runs on Google's services. You'll need a Google Account (which is also a Gmail address).

1. If you already use Gmail on a computer, sign in with that account
...
5. When it's done, it shows the time of the last backup
...
Apple made an app specifically for this called "Move to iOS." It only works during initial iPhone setup.

1. On your Android phone, download "Move to iOS" from the Google Play Store
2. During iPhone setup, when asked about transferring data, choose "Move Data from Android"
3. Your new iPhone will show a code
...
This is trickier because Apple and Google don't cooperate as nicely.
...
## Setting a Passcode, Face ID, and Fingerprint

Your passcode is the last line of defense if someone picks up your phone. Set a strong one.
...
**Pro tip:** Add your non-dominant finger too. When your phone is flat on a table, your non-dominant hand often unlocks it more naturally.

---

## Essential Settings to Change Immediately

Once the phone is set up and running, these are the settings worth adjusting before anything else.
...
**Quick access on both:** Swipe down from the top of the screen to open the notification shade. Tap the moon icon (Do Not Disturb) or the Focus icon to toggle it quickly.
...
## Common Tasks People Struggle With
...
- Samsung: Swipe the edge of your hand across the screen (palm swipe)
- Some phones have a screenshot button in the quick settings (swipe down from top)
...
**iPhone:** Swipe up from the bottom slowly to see all open apps. Swipe sideways to switch between them. On iPad (not iPhone), you can run two apps side by side.

**Android:** Tap the square "Overview" button (or swipe up and pause on phones without buttons). Long-press an app's header and tap "Split screen," then choose the second app.
...
*See also: [Email & Account Management](email-accounts.md) | [Digital Payments & Banking](payments-banking.md) | [WiFi & Networking](wifi-networking.md)*
