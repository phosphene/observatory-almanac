...
**Rules:**
1. Skip your opponent's store when sowing.
2. If the last seed lands in your own store, you take another turn immediately.
3. If the last seed lands in an empty pit on your own side AND the pit directly across from it (on your opponent's side) contains seeds, you capture: take both the last seed and all seeds in the opposite pit and place them in your store.
4. You do NOT capture if the opposite pit is empty.
...
On your turn, pick up all seeds from any one of your six pits and sow them counterclockwise, one per pit. Unlike Kalah:
- Sowing continues into the opponent's pits.
- There are no stores.
- If a pit contains more than 11 seeds, the sow will travel more than one full lap; skip the pit you started from.
