...
**The Cadillac of Poker** Â· 2â10 players Â· Ages 16+ Â· Variable
...
| --- | --- | --- | --- |
| 1 | Royal Flush | Aâ  Kâ  Qâ  Jâ  10â | Highest straight flush |
| 2 | Straight Flush | 8â¥ 7â¥ 6â¥ 5â¥ 4â¥ | Five consecutive same suit |
| 3 | Four of a Kind | Kâ  Kâ¥ Kâ¦ Kâ£ 7â | Four same rank |
| 4 | Full House | Qâ  Qâ¥ Qâ¦ 9â  9â¥ | Three of a kind + pair |
| 5 | Flush | Aâ¦ Jâ¦ 8â¦ 5â¦ 2â¦ | Five same suit, not sequential |
| 6 | Straight | 10â£ 9â¦ 8â¥ 7â  6â£ | Five consecutive, mixed suits |
| 7 | Three of a Kind | Jâ  Jâ¥ Jâ¦ 6â  2â£ | Three same rank |
| 8 | Two Pair | Aâ  Aâ¦ 9â¥ 9â£ Kâ | Two different pairs |
| 9 | One Pair | 7â  7â¦ Aâ  Kâ£ Qâ¥ | Two same rank |
| 10 | High Card | Aâ  Kâ¦ 9â¥ 6â£ 3â | None of the above |
...
The dealer button rotates clockwise one position after each hand. The button player deals (or nominates the deal) and acts last post-flopâthe most advantageous position.
...
**Example:** Player A has $50, B has $200, C has $200. A goes all-in for $50. B and C put in $200. The main pot contains $150 (50 Ã 3). The side pot contains $300 (150 Ã 2). A can only win the main pot; B and C contest the side pot among themselves.
...
Tournament blinds increase at set intervals (e.g., every 20 minutes). As blinds rise, average stack depth (in big blinds) decreases, forcing play. Late in tournaments, average stack is often 15â30 big blinds, dramatically changing strategy.

### ICM (Independent Chip Model)

Tournament chips are not worth their face value in cashâtheir value depends on your stack relative to others and the prize structure. ICM calculations inform calling and folding decisions near the money and at final tables.
...
* **Value bet:** Size to get called by worse hands. Typically 50â75% of pot on the river.
* **Bluff:** Same sizing as value bet (balanced ranges). Oversized bets can be powerful but are exploitable.
* **C-bet (continuation bet):** Bet on the flop after raising pre-flop, regardless of whether you hit. Typical size 33â50% of pot.

### Ranges

Think in terms of rangesâall the hands your opponent could have in a given situationârather than assigning a specific hand. Decisions improve when made against distributions, not guesses.
