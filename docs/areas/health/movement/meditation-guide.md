...
* **ð§ Meditation Timer** (below)
* [ð« Guided Breathing](../breathing-techniques/#practice-now)
...
Meditation is not emptying the mind â it is learning to observe the mind. Each tradition below offers a distinct entry point into this observation, drawing from thousands of years of practice across Asia, the Middle East, and indigenous cultures worldwide. Whether you have five minutes or fifty, whether you are drawn to silence or structure, there is a path here for you.

---

## How to Use This Guide

Read through all nine styles before committing to one. Try each for at least a week before evaluating. Most practitioners settle into one primary practice and draw from others as needed. Session length is less important than consistency â ten minutes daily outperforms two hours weekly.

**General preparation for all styles:**
- Find a quiet space with minimal interruptions
- Wear comfortable, non-restrictive clothing
- Set a timer so you are not checking the clock
- Sit on a chair, cushion, or floor â comfort matters more than form
...
**Tradition/Lineage:** TheravÄda Buddhism, originating in Southeast Asia (Myanmar, Thailand, Sri Lanka). Popularized in the West by teachers such as S.N. Goenka, Joseph Goldstein, Sharon Salzberg, and Jack Kornfield. The ten-day Goenka retreat is one of the most widely taught introductory formats.

**Core Principle:** Vipassana means "clear seeing" or "insight." The practice cultivates moment-to-moment awareness of sensations, thoughts, and emotions exactly as they arise â without reacting, clinging, or pushing away. Over time, practitioners observe the three characteristics of existence: impermanence (anicca), unsatisfactoriness (dukkha), and non-self (anatta).
...
5. If the mind wanders to thought, planning, memory, or fantasy â note it neutrally ("thinking") and return to the body scan.
6. Notice that all sensations â even intense pain â arise and pass. Everything is impermanent.
7. After the scan, rest in open awareness of the body as a whole field of sensation.

**Suggested Duration:**
- Beginner: 15â20 minutes
- Intermediate: 30â45 minutes
- Advanced: 60 minutes+, or full-day sitting retreats
...
| Frustration at mental chatter | The noticing of distraction IS the practice â not a failure |
...
**Tradition/Lineage:** TheravÄda Buddhism; one of the four brahmaviharÄs (divine abodes) alongside compassion (karuá¹Ä), empathetic joy (muditÄ), and equanimity (upekkhÄ). Extensively developed in Tibetan Buddhism as tonglen (giving and taking). Western teachers: Sharon Salzberg, Pema ChÃ¶drÃ¶n.

**Core Principle:** Metta means "loving-kindness" or "benevolent goodwill." The practice deliberately cultivates warmth, care, and well-wishing â beginning with oneself and radiating outward to increasingly challenging targets. It directly counters habitual states of judgment, resentment, and self-criticism.
...
7. Repeat each phrase slowly, feeling into its meaning rather than rushing. Allow any warmth to arise naturally â do not force it.
8. After 3â5 minutes, bring to mind a beloved person (a close friend, child, or pet). Direct the same phrases toward them: *May you be happy. May you be healthy...*
9. Expand to a neutral person â someone you neither like nor dislike, perhaps a neighbor or shop clerk.
...
**Suggested Duration:**
- Beginner: 10â15 minutes
- Intermediate: 20â30 minutes
- Advanced: 45 minutes, including extended difficult-person work
...
| Self-directed phrases feel hollow or uncomfortable | This is common and meaningful â the self often receives the least compassion |
...
1. Lie down on your back in savasana position â arms slightly away from the body, palms up, legs uncrossed. You may use a blanket.
...
4. On an exhale, release awareness from the left foot and move to the left lower leg â the calf, the shin, the ankle.
...
**Suggested Duration:**
- Beginner: 20â30 minutes (this practice benefits from unhurried pacing)
- Intermediate: 30â45 minutes
- Advanced: 45â60 minutes
...
| Discomfort or pain in a region | Do not skip it â breathe into it; stay curious rather than resistant |

---

## 4. Zazen (Zen Sitting)

**Tradition/Lineage:** Zen Buddhism (Chan in China, Seon in Korea, Thiá»n in Vietnam). DÅgen Zenji (13th century Japan) formalized zazen in his text *Fukanzazengi*. The practice is central to both Rinzai and SÅtÅ Zen schools. Contemporary Western Zen teachers include Shunryu Suzuki (*Zen Mind, Beginner's Mind*) and Thich Nhat Hanh.

**Core Principle:** Zazen ("seated Zen") is not a technique for achieving a state â it *is* the state. The practice is often described as "just sitting" (shikantaza). Form, posture, and attitude are as important as mental activity. DÅgen taught: "To study the self is to forget the self."

**Complete Instructions â Counting Breaths (Entry Practice):**
...
**Suggested Duration:**
- Beginner: 15â20 minutes, once or twice daily
- Intermediate: 25â35 minutes
- Advanced: 40 minutes (one full period, or "zazen"), often in pairs at Zen centers
...
6. Visualization: Follow any guided imagery offered â a starry sky, a golden sun, a still lake.
...
**Suggested Duration:**
- Beginner: 20â30 minutes
- Intermediate: 35â45 minutes
- Advanced: 60 minutes (or multiple sessions daily)
...
| Not being able to follow the rotation fast enough | Don't worry â approximate attention is sufficient |
...
**Tradition/Lineage:** Present in TheravÄda Buddhism (kinhin in Japanese Zen, used between sitting periods), Tibetan Buddhist traditions, and Thich Nhat Hanh's Plum Village tradition. Also appears in Christian contemplative walking (labyrinth walking) and Sufi traditions.
...
1. Choose a clear path of 10â20 steps (indoors or outdoors). Remove shoes if possible.
...
- Beginner: 10â15 minutes
- Intermediate: 20â30 minutes
- Advanced: As a standalone practice, 45+ minutes; also used as integration between sitting sessions
...
**Tradition/Lineage:** Vedic tradition dating back thousands of years; central to Hindu devotional practice (japa â repetition of deity names), Transcendental Meditation (TM, founded by Maharishi Mahesh Yogi in the 1950s), and Tibetan Buddhism (mantra recitation, e.g., *Om Mani Padme Hum*). Also found in Christian hesychasm (the "Jesus Prayer") and Sufi dhikr.
...
**Accessible mantras for secular practice:**
- *So Hum* ("I am that" â Sanskrit; synchronize "So" with inhale, "Hum" with exhale)
- *Om* (primordial sound; often used in single long repetitions)
- *Peace* (silently on exhale)
- Any personally meaningful word or phrase

**Complete Instructions:**

1. Sit comfortably. Close your eyes. Take three settling breaths.
2. Introduce the mantra silently: repeat it gently in your mind. Do not force it or mechanically clock it â let it arise naturally.
3. When the mind wanders to thought, return to the mantra. Do not be harsh.
4. Allow the mantra to become quieter and quieter, more like a whisper than a shout. It may become very faint or disappear entirely â this is fine. It will return.
5. After the session, sit quietly for 2â3 minutes before opening your eyes. This transition time is valued in TM as part of the integration process.

**Suggested Duration:**
- Beginner: 10â15 minutes, twice daily (TM recommends this frequency)
- Intermediate: 20 minutes twice daily
- Advanced: 20â30 minutes twice daily
...
| Choosing the "right" mantra | Start with *So Hum* â it is well-tested and widely used |

---

## 8. Mindfulness of Breath (ÄnÄpÄnasati)

**Tradition/Lineage:** Explicitly taught by the Buddha in the *ÄnÄpÄnasati Sutta* (Discourse on Mindfulness of Breathing), part of the Majjhima NikÄya. Practiced across virtually all Buddhist schools. The most widely taught secular meditation form in clinical settings (MBSR, MBCT). Foundation of most Western mindfulness instruction.

**Core Principle:** The breath is always present, always in the moment, always arising and passing. By anchoring attention to the breath, practitioners train the capacity to observe without grasping. The breath is the meditation object; wandering and returning to it builds attentional stability (samÄdhi).
...
3. Rest your attention there. You do not need to control the breath â breathe naturally.
4. When the mind wanders (and it will, repeatedly â this is not failure), simply notice that it has wandered and gently return to the breath.
...
7. Over time, the returns become shorter and the breath periods longer â this is concentration developing.

**The RAIN technique** (useful when strong emotions arise during practice):
- **R**ecognize what is present
- **A**llow it to be there
- **I**nvestigate with curiosity
- **N**on-identification ("this is a sensation, not 'me'"

**Suggested Duration:**
- Beginner: 5â10 minutes (this is the easiest entry point; short sessions are encouraged)
- Intermediate: 20â30 minutes
- Advanced: 45+ minutes
...
**Core Principle:** Rather than focusing on any particular object (breath, sensations, mantra), the practitioner rests in the open, spacious quality of awareness itself â the medium in which all experiences arise and pass. There is no "doing" in this practice; rather, the habitual search for a meditation object is relaxed, and awareness is recognized as already present.
...
1. Begin with 5â10 minutes of breath awareness to settle the mind.
...
**Suggested Duration:**
- Beginner: 5â10 minutes appended to another practice
- Intermediate: 15â20 minutes as a standalone practice
- Advanced: 30â45 minutes, or as the primary practice for experienced meditators

**Common Obstacles & Solutions:**

| Obstacle | Solution |
| --- | --- |
| "I don't understand what I'm supposed to do" | That confusion IS the practice pointing â there is no doer to do anything |
...
| --- | --- | --- | --- | --- |
| Vipassana | Body sensations | TheravÄda Buddhism | Insight, habit change | Intermediate |
| Metta | Phrases + visualization | Buddhism | Emotional healing, relationships | Beginner-friendly |
| Body Scan | Body regions | MBSR / TheravÄda | Stress, pain, sleep | Beginner |
...
| Breath (ÄnÄpÄnasati) | Breath sensations | Buddhism / Secular | Attention training | Beginner |
...
**Week 1â2:** Mindfulness of Breath, 5â10 minutes daily
**Week 3â4:** Extend to 15â20 minutes; experiment with Body Scan before sleep
**Month 2:** Add Metta 2â3 times per week; try Walking Meditation on weekends
**Month 3+:** Choose a primary practice; supplement with others as called
...
<div id="med-tool" markdown>

<div style="text-align:center; padding:20px; background:#f5f5f0; border-radius:8px; margin:1em 0;">
<div style="margin-bottom:12px;">
<label><strong>Duration:</strong></label>
<select id="med-dur" style="padding:6px; font-size:14px; border-radius:4px;">
<option value="300">5 min</option><option value="600">10 min</option>
<option value="900">15 min</option><option value="1200" selected>20 min</option>
<option value="1800">30 min</option><option value="2700">45 min</option>
<option value="3600">60 min</option>
</select>
</div>
<div id="med-display" style="font-size:4em; font-family:monospace; margin:20px 0;">20:00</div>
<div style="margin:12px 0;">
<button onclick="medStart()" style="padding:10px 20px; font-size:16px; margin:4px; cursor:pointer; border-radius:6px; border:1px solid #888; background:#fff;">▶ Start</button>
<button onclick="medPause()" style="padding:10px 20px; font-size:16px; margin:4px; cursor:pointer; border-radius:6px; border:1px solid #888; background:#fff;">⏸ Pause</button>
<button onclick="medReset()" style="padding:10px 20px; font-size:16px; margin:4px; cursor:pointer; border-radius:6px; border:1px solid #888; background:#fff;">🔄 Reset</button>
</div>
</div>
...
<script>
(function() {
  let remaining = 1200, timer = null, audioCtx = null;

  function display() {
    const m = Math.floor(remaining / 60), s = remaining % 60;
    document.getElementById("med-display").textContent =
  ...
  window.medStart = function() {
    ...
    timer = setInterval(() => {
      remaining--;
      display();
      if (remaining <= 0) { clearInterval(timer); timer = null; playBell(); }
    }, 1000);
  };
  window.medPause = function() { if (timer) { clearInterval(timer); timer = null; } };
  window.medReset = function() {
    if (timer) { clearInterval(timer); timer = null; }
    remaining = parseInt(document.getElementById("med-dur").value);
    display();
  };

  document.getElementById("med-dur").addEventListener("change", function() {
    if (!timer) { remaining = parseInt(this.value); display(); }
  });
  display();
})();
</script>
