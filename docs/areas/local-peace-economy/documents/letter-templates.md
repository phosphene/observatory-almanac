...
- Do NOT include grievances, even if justified
- Keep a copy for your records
- Deliver in person when possible, then follow up with the written letter
...
**When to use:** Professional mistakes, damaged relationships, public incidents.
**Tone:** Accountable, sincere, non-defensive. No excuses.
**The test:** If your letter includes more "but" sentences than acknowledgment sentences, rewrite it.
...
> \_\_\_\_\_ [number] guests will attend. Meal choice: [options]
