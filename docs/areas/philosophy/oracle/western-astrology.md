...
The zodiac is a belt of sky approximately 18Â° wide centered on the ecliptic â the apparent path of the Sun through the heavens over the course of a year. The zodiac is divided into twelve equal 30Â° segments, each associated with a constellation. In **tropical astrology** (the dominant Western system), these signs are fixed to the seasons rather than the actual star positions â the vernal equinox always marks the beginning of Aries, regardless of where the constellation Aries actually appears in the sky.

Each sign has four primary attributes:
- **Dates** (approximate Sun ingress)
- **Element:** Fire, Earth, Air, or Water
- **Modality:** Cardinal (initiating), Fixed (sustaining), or Mutable (adapting)
- **Ruling Planet(s)**
...
**Dates:** April 20 â May 20  
**Element:** Earth | **Modality:** Fixed | **Ruler:** Venus

Fixed earth: the immovable, the permanent, the sensual. Taurus governs the material world in all its beauty and solidity â food, music, physical comfort, the pleasures of the senses. Taurus individuals tend to be patient, persistent, reliable, and deeply attached to security and comfort. They build slowly and enduringly. Their relationship to beauty â visual, culinary, musical â is often highly developed.
...
### â Libra â The Scales

**Dates:** September 23 â October 22  
...
### â Sagittarius â The Archer

**Dates:** November 22 â December 21  
...
### â Capricorn â The Sea-Goat

**Dates:** December 22 â January 19  
**Element:** Earth | **Modality:** Cardinal | **Ruler:** Saturn

Cardinal earth: the initiating, goal-oriented, structural earth. Capricorn governs ambition, authority, discipline, career, tradition, and the long view of time. Capricorn individuals are often highly disciplined, practical, and ambitious â willing to work long and hard toward significant goals. They respect structure and earned authority.
...
### â Aquarius â The Water-Bearer

**Dates:** January 20 â February 18  
**Element:** Air | **Modality:** Fixed | **Ruler:** Uranus (traditional: Saturn)

Fixed air: the committed idea, the principle, the idealistic intellect. Aquarius governs innovation, humanitarianism, community, revolution, and the future. Aquarius individuals are often intellectually innovative and possessed of a genuine concern for humanity in the abstract â sometimes at the expense of intimacy with individuals in particular.
...
The birth chart â the horoscope â is divided into twelve houses, each governing a specific domain of life. The houses are determined by the time and place of birth, as they depend on the exact position of the horizon at the moment of birth.
...
Aspects are the angular relationships between planets in a chart. They are the grammar of astrological interpretation â they describe how the energies symbolized by different planets interact.

**Conjunction (0Â°):** Blending of energies. Intensification. The planets act together. Can be harmonious or tense depending on the planets involved.

**Opposition (180Â°):** Tension, polarity, the need for integration. Two planets pulling in opposite directions, seeking balance.

**Trine (120Â°):** Natural harmony and ease. Talents that flow effortlessly. The blessing aspect â though sometimes indicating energy that is taken for granted.

**Square (90Â°):** Friction, challenge, the drive to overcome obstacles. Often associated with significant achievement through struggle.

**Sextile (60Â°):** Opportunity, potential. Like the trine but requiring more conscious engagement to activate.

**Quincunx/Inconjunct (150Â°):** Adjustment, awkwardness. Two energies that don't naturally speak the same language and require constant recalibration.

**Semi-square (45Â°) and Sesquiquadrate (135Â°):** Minor friction aspects. Smaller but persistent irritants.
...
The chart shows:
- **The Sun:** Core identity, the conscious self, the ego's center of gravity
- **The Moon:** Emotional nature, instinctive response, the unconscious self, early conditioning
- **Mercury:** Mind, communication, learning style
- **Venus:** Aesthetics, relationships, what one values and desires
- **Mars:** Drive, ambition, assertion, sexuality, how one pursues desires
- **Jupiter:** Expansion, optimism, luck, where life tends to grow and generosity manifests
- **Saturn:** Discipline, limitation, karma, where hard work is required
- **Uranus:** Disruption, innovation, the unexpected, collective awakening
- **Neptune:** Dissolution, illusion, spirituality, transcendence
- **Pluto:** Transformation, power, regeneration, the underworld
...
*Astrology does not determine. It illuminates. The wise engagement with any symbolic system is not to be told what will happen but to expand one's understanding of what might be, and why. The stars, as Shakespeare observed, do not hold us in thrall â but they may, for those who learn to read them, offer a language for what we already sense in the deep currents of our own becoming.*

---

## âï¸ Your Birth Chart

### Quick Reading â Just Your Birthday

Enter your birth date for your Sun Sign:

âï¸ Find My Sun Sign
ð­ Want more precision? Add birth time & place

**For a more complete reading, add:**

Birth Time (for Rising Sign / Ascendant):
Birth City (for house placements):

ð­ Calculate Full Chart

*Birth time determines your Rising Sign (Ascendant) â the mask you wear in public and how others first perceive you. Without it, we can only show your Sun Sign. Birth city helps with house placements. The more data, the more precise the reading.*

## ☀️ Find Your Sun Sign

<div id="sunsign-tool" markdown>

<div style="text-align:center; margin:1em 0;">
<label for="birth-date" style="font-size:1.1em;">Enter your birth date: </label>
<input type="date" id="birth-date" style="padding:8px; font-size:16px; border-radius:6px; border:1px solid #888;">
<button onclick="findSunSign()" style="padding:10px 20px; font-size:16px; margin-left:8px; cursor:pointer; border-radius:6px; border:1px solid #888; background:#fff;">Find Sign</button>
</div>

<div id="sunsign-result" style="text-align:center; padding:20px; background:#f5f5f0; border-radius:8px; margin:1em 0; display:none;"></div>
...
(function() {
  const signs = [
    {name:"Capricorn",symbol:"♑",dates:"Dec 22 – Jan 19",desc:"Ambitious, disciplined, practical. The mountain goat climbs steadily toward mastery."},
    {name:"Aquarius",symbol:"♒",dates:"Jan 20 – Feb 18",desc:"Independent, humanitarian, visionary. The water-bearer pours knowledge for all."},
    {name:"Pisces",symbol:"♓",dates:"Feb 19 – Mar 20",desc:"Intuitive, compassionate, artistic. The fish swims between worlds of dream and reality."},
    {name:"Aries",symbol:"♈",dates:"Mar 21 – Apr 19",desc:"Bold, pioneering, energetic. The ram charges forward with unstoppable initiative."},
    {name:"Taurus",symbol:"♉",dates:"Apr 20 – May 20",desc:"Steady, sensual, determined. The bull finds strength in patience and pleasure."},
    {name:"Gemini",symbol:"♊",dates:"May 21 – Jun 20",desc:"Curious, adaptable, communicative. The twins dance between perspectives."},
    {name:"Cancer",symbol:"♋",dates:"Jun 21 – Jul 22",desc:"Nurturing, protective, intuitive. The crab carries home wherever it goes."},
    {name:"Leo",symbol:"♌",dates:"Jul 23 – Aug 22",desc:"Creative, generous, dramatic. The lion radiates warmth and commands attention."},
    {name:"Virgo",symbol:"♍",dates:"Aug 23 – Sep 22",desc:"Analytical, helpful, precise. The maiden discerns what others overlook."},
    {name:"Libra",symbol:"♎",dates:"Sep 23 – Oct 22",desc:"Harmonious, diplomatic, aesthetic. The scales seek balance in all things."},
    {name:"Scorpio",symbol:"♏",dates:"Oct 23 – Nov 21",desc:"Intense, transformative, perceptive. The scorpion probes the depths others fear."},
    {name:"Sagittarius",symbol:"♐",dates:"Nov 22 – Dec 21",desc:"Adventurous, philosophical, free. The archer aims for truth beyond the horizon."}
  ];
  // Month-day boundaries (month is 0-indexed)
  const bounds = [[0,20],[1,19],[2,21],[3,20],[4,21],[5,21],[6,23],[7,23],[8,23],[9,23],[10,22],[11,22]];

  window.findSunSign = function() {
    const input = document.getElementById("birth-date").value;
    if (!input) return;
    const d = new Date(input + "T12:00:00");
    const m = d.getMonth(), day = d.getDate();
    let idx = m; // default: sign starts at boundary
    if (day < bounds[m][1]) idx = (m + 11) % 12;
    const sign = signs[idx];
    document.getElementById("sunsign-result").innerHTML =
      `<div style="font-size:3em;">${sign.symbol}</div>
       <div style="font-size:1.5em; font-weight:bold; margin:8px 0;">${sign.name}</div>
       <div style="color:#666;">${sign.dates}</div>
       <div style="margin-top:12px;">${sign.desc}</div>`;
    document.getElementById("sunsign-result").style.display = "block";
  };
})();
</script>
