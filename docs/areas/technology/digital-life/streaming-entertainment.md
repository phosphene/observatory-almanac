...
**Roku:** The most user-friendly. Simple interface, no subscription required, works with all major streaming services. The Roku Stick 4K is excellent and usually around $40-50. Best for: people who want simplicity and don't care about brand ecosystems.
...
**Which to choose:** For most people, Roku or Fire Stick. If you have an iPhone, Apple TV is worth considering. Don't buy a streaming device that's the same as what your smart TV already runs (no need for a Roku device if your TV runs Roku software natively).

### Signing Into Accounts on a TV

Typing with a remote is miserable. Streaming services know this and offer better options:

**QR code method:** When signing into an app on your TV, look for an option like "Sign in on a mobile device" or "Use app to sign in." A QR code appears on screen. Open your phone camera, scan it, and your phone takes you directly to the sign-in page. Much faster.

**Code on screen method:** Many services show a short code on your TV (like "AB3C7F") and tell you to go to a website on your phone or computer (e.g., netflix.com/activate). You enter the code there while signed in, and the TV confirms automatically. No typing on the TV required.

**Browser sign-in:** On Apple TV and Google TV, you can use your phone as a keyboard for the TV. On Roku: download the Roku app and use your phone as a remote.
...
**Full surround sound:** Separate receiver plus multiple speakers. Excellent but complex to set up and wires everywhere. Worth it for dedicated home theater rooms.

**The practical choice:** A soundbar for the living room TV. The improvement over built-in speakers is immediately noticeable and setup is simple.
...
### Live TV Streaming (Cable Alternatives)
...
**Spotify free:** Has ads (audio every few songs) and limitations on mobile (shuffle-only on albums, no unlimited skips). Fine for casual listening. Works fully on desktop.

**Paid tiers** on any service: No ads, unlimited skips, offline downloads, higher audio quality, access to full features on mobile.
...
### Connecting to Speakers and Car
...
### Tracking What's on Which Service
...
Most major services have now cracked down on sharing passwords outside your household:

**Netflix:** Requires devices to connect to your home network regularly. Offers a "paid sharing" add-on (~$8/month) to add members outside your household. Enforcement has varied by account.

**Disney+:** Similarly restricts sharing; may prompt to transfer a profile to a separate account.

**Practical reality:** If you've been sharing with family across town, you'll likely need separate accounts now or to use the official "add a member" features. These are more expensive but legal.

**Tip:** If a family member is in college, many services offer student discounts through verification services like UNiDAYS or Student Beans. Spotify Student is half price, for example.
...
**Spotify:** Your playlists are preserved if you downgrade to free; you can still access them in shuffle mode. They're there when you re-upgrade.

**General tip:** Take screenshots of your watchlists before cancelling if you don't plan to return. JustWatch lets you maintain a watchlist that's service-agnostic.

### Family Plans: How They Work

Most streaming services offer family or household plans that are cheaper per person.

**What "household" means:** Devices on the same WiFi network and/or sharing the same geographic location. The rules vary and are increasingly strict.

**Typical family plan benefits:**
- Multiple simultaneous streams (a single account may only allow 1-2 at a time; a family plan allows 4-6)
- Multiple profiles (each person gets their own recommendations, history, and watchlist)
- Often slight cost savings over individual plans

**Spotify Premium Family ($17/month):** Up to 6 accounts in the same home. Each person has their own library and discover weekly. Best value in music streaming for families.
...
*See also: [WiFi & Networking](../wifi-networking/) | [Smartphone Setup](../smartphone-setup/)*