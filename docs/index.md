...
The Observatory Almanac is a structured, git-native mirror of [observatory.wiki](https://observatory.wiki) and a companion reference library. Every document carries explicit YAML frontmatter that makes metadata machine-readable without a database.

All Observatory.wiki content is © Independent Media Institute, licensed [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).
Almanac-native content is MIT licensed.
